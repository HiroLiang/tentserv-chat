...
use commands::e2ee::{
    ...
    decrypt_with_sender_key, delete_sender_keys, encrypt_with_sender_key, generate_identity_keys,
    generate_sender_key, generate_signed_pre_key, get_identity_keys, get_sender_key_states,
...
pub fn run() {
    tauri::Builder::default()
        .manage(ChatRuntimeManager::default())
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            chat_runtime_start,
            chat_runtime_stop,
            chat_set_active_room,
            chat_get_rooms_snapshot,
            chat_get_room_snapshot,
            chat_send_message,
            chat_retry_message,
            chat_mark_room_read,
            // Messages
