...
export const e2eeApi = {
    uploadIdentityKey: (device_id: string, public_key: string, sign_public_key: string): Promise<void> =>
    ...
    uploadOTPPreKeys: (device_id: string, keys: { key_id: number; public_key: string }[]): Promise<void> =>
